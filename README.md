...
[![Go Version](https://img.shields.io/github/go-mod/go-version/ivanjosipovic/pia-wg-config)](https://golang.org/doc/devel/release.html)
...
```bash
go install github.com/ivanjosipovic/pia-wg-config@latest
```
...
RUN go install github.com/ivanjosipovic/pia-wg-config@latest
...
```bash
git clone https://github.com/ivanjosipovic/pia-wg-config
cd pia-wg-config
...
1. Check the [Issues](https://github.com/ivanjosipovic/pia-wg-config/issues) page
